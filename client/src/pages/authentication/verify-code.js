...
const VerifyCode = (props) => {
  ...
  return (
    <>
      <Head>
        <title>Verify Code | Truckar</title>
      </Head>
      <Box
        component="main"
        sx={{
          ...
          <Card elevation={16} sx={{ p: 4 }}>
            ...
            >
              ...
              <Typography color="textSecondary" sx={{ mt: 2 }} variant="body2">
                {`Confirm registration using your verification code sent on ${
                  router.query.mobile
                    ? `Mobile Number: +91 ${router.query.mobile}`
                    : `Email ID: ${router.query.email} `
                }`}
              </Typography>
            </Box>
            <Box
            ...
            >
              {platform === "Amplify" && (
                <AmplifyVerifyCode email={router.query.email} />
              )}
            </Box>
            <Divider sx={{ my: 3 }} />
            {platform === "Amplify" && (
