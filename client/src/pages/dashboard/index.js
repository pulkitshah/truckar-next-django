...
const Overview = () => {
  globalThis.sessionStorage.setItem("dismiss-welcome-banner", "false");

  const [displayWelcomeBanner, setDisplayWelcomeBanner] = useState(
    !(globalThis.sessionStorage.getItem("dismiss-welcome-banner") === "true")
  );
  ...
  const handleDismissWelcomeBanner = () => {
    globalThis.sessionStorage.setItem("dismiss-welcome-banner", "true");
    setDisplayWelcomeBanner(false);
  };
        ...
        <Container maxWidth="xl">
          ...
          <Grid container spacing={4}>
            {displayWelcomeBanner && (
              <Grid item xs={12}>
                <OverviewBanner onDismiss={handleDismissWelcomeBanner} />
              </Grid>
            )}
