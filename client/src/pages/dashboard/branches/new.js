...
import { BranchCreateForm } from "../../../components/dashboard/branch/branch-create-form";
...
const BranchCreate = () => {
  ...
  return (
    <>
      <Head>
        <title>Dashboard: Branch Create | Truckar</title>
      </Head>
      <Box
        component="main"
        sx={{
      ...
      >
        <Container>
          <Box sx={{ mb: 3 }}>
            <Typography variant="h4">Create a new branch</Typography>
