    ...
    >
      ...
      >
        ...
        <Typography
          ...
          sx={{ py: 3 }}
        >
          Truckar is a comprehensive Transport Management Software. We provide
          Trucking TMS solutions to maximize the efficiency of your vehicle
          fleet.
        </Typography>
        <Box
          sx={{
        ...
        >
          ...
          {["Transporters", "Brokers", "Truck Owners"].map((item) => (
            <Box
              key={item}
              sx={{
                alignItems: "center",
